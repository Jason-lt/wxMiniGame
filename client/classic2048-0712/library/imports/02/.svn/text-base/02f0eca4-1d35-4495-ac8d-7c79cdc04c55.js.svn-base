...
cc.Class({
    ...
    shareGame: function shareGame() {
        ...
        if (typeof FBInstant !== 'undefined') {
            ...
            console.log('----------------复活分享-----------------');
            ThirdAPI.shareGame('randomImg', this.onShareSuccess.bind(this), this.onShareFailed.bind(this), '233');
        } else {
            this.onShareSuccess();
        }
    ...
    shareNotRevive: function shareNotRevive() {
        ...
        if (typeof FBInstant !== 'undefined') {
            ...
            ThirdAPI.shareGame('randomImg', this.onShareNotReviveSuccess.bind(this), this.onShareFailed.bind(this), '233');
        } else {
