"use strict";
cc._RF.push(module, 'ab6408y4ihGvpo29uPO2m4E', 'shareUI');
...
cc.Class({
    ...
    onShareGame: function onShareGame() {
        ...
        if (typeof FBInstant !== 'undefined') {
            ...
            ThirdAPI.shareGame('screenshot', this.onShareSuccess.bind(this), this.onShareFail.bind(this), '235');
        }
    },
    ...
    //分享得钻石
    getStoneForShare: function getStoneForShare() {
        Global.game.playSound('btn', 0.1);
        if (typeof FBInstant !== 'undefined') {
            var myUtil = require('myUtil');
            ThirdAPI.shareGame(myUtil.getImgBase64(), this.onShareSuccess.bind(this));
        } else {
            ThirdAPI.shareGame('randomImg', this.onGetStoneSuccess.bind(this), this.onShareFail.bind(this), '234');
        }
    },

    //分享得钻石成功
    onGetStoneSuccess: function onGetStoneSuccess(openGId) {
        //结算界面通过送钻石分享成功
        var biManager = require('biManager');
