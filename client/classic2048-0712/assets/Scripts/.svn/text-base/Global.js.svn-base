window.Global = {
    cdnGameConfig: {
        ...
        "markScoreEquals": [1024], //可以加标识的分数格子
        "scoreEquals": [2048, 4096], //弹出宝箱的分数
        ...
        "createGridNumForClear": 5, //生产格子数量产生消除锤锤
        "createGridNumForSuper": 10, //生产格子数量产生万能道具
        "histroyMaxScore": 200, //历史最高分数,
        "dailyStartTime": 1531187498, //是秒数，不是毫秒
        "version": "v.1.6.5"
    },
    bannerAdConfig: {
        "swith": true,
