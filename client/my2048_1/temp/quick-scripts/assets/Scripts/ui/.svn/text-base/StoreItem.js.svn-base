(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Scripts/ui/StoreItem.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'a4c47PqE5hCjIciwhmBcxrv', 'StoreItem', __filename);
    ...
    onButtonBy: function onButtonBy() {
        ...
        if (!this.isHave) {
            ...
            // 不可以购买
                    ...
                    Global.storeUI.getComponent("UIStore").showTipbox('您的星星数量不够！');
                    return;
                }
            ...
            biManager.bilog(biManager.buyskin, null);
