(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Scripts/component/castOffNode.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '958843fG4RDN6vr7VmYyPWg', 'castOffNode', __filename);
// Scripts/component/castOffNode.js
...
cc.Class({
    ...
    _onTouchMove: function _onTouchMove(data) {
        ...
        if (this.wasteNumer < 2) {
            ...
            var cardRect = cc.rect(grid_pos.x - winSize.width / 2 - this.wasteKuang.width / 2, grid_pos.y - wxGame.Global.isXInter, this.wasteKuang.width, this.wasteKuang.height);
    ...
    setWasteState: function setWasteState() {
    ...
    setTipsLabel: function setTipsLabel() {
    ...
    setLastOperation: function setLastOperation(isOperation) {
    ...
    onClickCastOffBtn: function onClickCastOffBtn() {
        if (!wxGame.shareConfig.castOff.isUse) {
            return;
        }
        //垃圾桶满了
    ...
    //清理
    clearCastOff: function clearCastOff() {
        this.wasteNumer = 0;
        this.setWasteState();
        this.setTipsLabel();
    },
...
cc._RF.pop();
        ...
        //# sourceMappingURL=castOffNode.js.map
