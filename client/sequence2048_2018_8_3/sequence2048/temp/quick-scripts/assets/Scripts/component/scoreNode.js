(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Scripts/component/scoreNode.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '25b25Rxx6JO4Jql9ofCxbce', 'scoreNode', __filename);
// Scripts/component/scoreNode.js
...
cc.Class({
    ...
    //停止刷新当前排行
    stopUpdateRank: function stopUpdateRank() {
        tywx.Timer.cancelTimer(this, this.updateRank);
    },
    ...
    //计算分数两端区间数
    getScoreSection: function getScoreSection(score) {
        var index = 0;
