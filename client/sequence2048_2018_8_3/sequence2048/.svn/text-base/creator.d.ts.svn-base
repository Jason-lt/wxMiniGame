	...
	*/
	...
	export class NodePool {		
		...
		*/
		...
		@example 
		```js
		var myNode = cc.instantiate(this.template);
	...
	export class Scheduler {		
		...
		*/
		...
		<p>
		  ...
		  repeat var the action be repeated repeat + 1 times, use cc.macro.REPEAT_FOREVER to var the action run continuously<br/>
	...
	export class EditBox extends _RendererUnderSG {		
		...
		/**
		!#en var the EditBox get focus, only valid when stayOnTop is true.
	...
	export class Pipeline {		
		...
		*/
		...
		/**
		!#en
		var new items flow into the pipeline. </br>
		...
		*/
		...
		/**
		!#en
		var new items flow into the pipeline and give a callback when the list of items are all completed. </br>
