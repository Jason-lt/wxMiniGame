...
tywx.TuyooSDK = {
    ...
    */
    loginTuyooWithCode: function (code, userInfo) {
        if (!tywx.IsWechatPlatform()) {
            tywx.LOGD(null, 'file = [TuyooSDK] fun = [loginTuyooWithCode] return');
            return;
        }
        // 微信授权成功后使用code登录途游服务器
        wx.showShareMenu({
        ...
        tywx.LOGD(null, 'file = [TuyooSDK] fun = [loginTuyooWithCode] dataObj = ' + JSON.stringify(dataObj));
        ...
        wx.request({
            ...
            success: function (params) {
                tywx.LOGD(null, 'file = [TuyooSDK] fun = [loginTuyooWithCode] success params = ' + JSON.stringify(params));
                ...
                tywx.PropagateInterface.getUserFeatureInfo();//获取用户特征
            ...
            fail: function (params) {
                ...
                tywx.LOGD(null, 'file = [TuyooSDK] fun = [loginTuyooWithCode] fail params = ' + JSON.stringify(params));
    ...
    if (tywx.IsWechatPlatform()) {
        ...
        wx.onShow(function (result) {
            ...
            if (query && query.gdt_vid && query.weixinadinfo) {
                ...
                tywx.BiLog.clickStat(tywx.clickStatEventType.clickStatEventTypeUserFrom, [scene, from]);
                ...
                tywx.BiLog.clickStat(tywx.clickStatEventType.clickStatEventTypeUserFrom, [scene, query.inviteCode, query.sourceCode, query.imageType, "CardActive"]);
            } else {
                if (tywx.Util.isSceneQrCode(scene)) {
                    ...
                    tywx.BiLog.clickStat(tywx.clickStatEventType.clickStatEventTypeUserFrom, [scene, scenePath]);
                } else {
