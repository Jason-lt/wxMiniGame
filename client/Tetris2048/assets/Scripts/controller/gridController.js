...
cc.Class({
    ...
    initGridData: function () {
        ...
        this.startY = -(Global.screenHeight / 2) + Global.paddingButtom + allHeight - Global.itemSize + 30 - this.fitOffsetY;
    ...
    createItem: function () {
        ...
        if (this.randomScore == 0) {
            this.randomScore = Util.randomForArray(Global.gridRandomScores);
        }
    ...
    setSoonGrid: function () {
        ...
        this.randomScore = Util.randomForArray(randomScores);
    ...
    reset: function () {
        ...
        //重新根据权重生成数字
        var Util = require('Util');
        Util.randomForWeight(Global.weightScores);
    },
});