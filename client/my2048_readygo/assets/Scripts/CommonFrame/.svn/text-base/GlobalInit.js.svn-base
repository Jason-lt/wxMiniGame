...
//应用系统信息
tywx.SystemInfo = {
    clientId: 'H5_2.0_weixin.weixin.0-hall20065.weixin.wdfk2048',
    intClientId: 24051, // 24051
    cloudId: 30, //休闲游戏统一用30，区分每个独服的标识
    version: 2.0,
    webSocketUrl: 'ws://192.168.10.88/',
    loginUrl: 'https://xyxsx.nalrer.cn/', //韩二辉征途提供//xyxsx.nalrer.cn/  仿真：xyxsxfz.nalrer.cn/ 正式服
    // loginUrl: 'http://192.168.20.140:8000/', //测试服
    shareManagerUrl: 'https://market.touch4.me/',
    deviceId: 'wechatGame',
    wxAppId: 'wxb5bbc7baaf5460c3', //旅行小西瓜wxAPPid
    appId: 20065,
    gameId: 20065,
    hall_version: "hall37",
...
(function () {
     ...
     */
    tywx.hex_md5 = function (s) {
        return binl2hex(core_md5(str2binl(s), s.length * chrsz));
    };
    tywx.b64_md5 = function (s) {
        return binl2b64(core_md5(str2binl(s), s.length * chrsz));
    };
    tywx.str_md5 = function (s) {
        return binl2str(core_md5(str2binl(s), s.length * chrsz));
    };
    tywx.hex_hmac_md5 = function (key, data) {
        return binl2hex(core_hmac_md5(key, data));
    };
    tywx.b64_hmac_md5 = function (key, data) {
        return binl2b64(core_hmac_md5(key, data));
    };
    tywx.str_hmac_md5 = function (key, data) {
