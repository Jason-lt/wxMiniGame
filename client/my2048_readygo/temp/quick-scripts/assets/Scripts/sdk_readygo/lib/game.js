(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Scripts/sdk_readygo/lib/game.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'df9a7oGEVhBtYhmc+KYGzNR', 'game', __filename);
...
function _interopRequireDefault(e) {
  ...
  try {
    var t = new Date().getTime();wx.setStorageSync("lastGetBannerTime", t), gameHttps(_config2.default.api + "game/getSwitchConfig?appId=" + _config2.default.appId, "", "GET").then(function (a) {
  ...
  myLog(e);for (var a in e) {
    if ("boolean" != typeof e[a] && (null == e[a] || "" == e[a] || "undefined" == e[a])) return console.log(e[a]), -1;
  }return 1;
}function getErrparamData(e) {
  return myLog(e), { code: -10111, data: "", msg: e };
}function gameLogin(e, a, t) {
  try {
    wx.login({ success: function success(n) {
        var o = n.code,
            r = { code: o, appId: _config2.default.appId, sdkVersion: sdkVersion, noNeedAuthorize: t || !1 };if (1 == Checkparam(r)) http(r, "POST", "user/login").then(function (t) {
          if (0 == t.code) {
          ...
          var i = "前端检查参数不正确" + JSON.stringify(r),
              d = getErrparamData(i);a(d);
        }
      }, fail: function fail(e) {
        a(e);
      } });
  ...
  try {
    var n = Checkparam(e);if (1 == gameSdk.midasPayCheckIng) {
      ...
      myLog({ name: "成功获取订单", res: e });var n = e.data;orderCode = e.data.orderCode;var o = e.data.buyQuantity;waitOrderTime = 1, 0 == o ? (gameSdk.midasPaying = !1, gameSdk.midasPayCheckIng = !0, checkOrder(a, t)) : (console.log("midasPaytime====真正的米大师支付时间", Date.now(), "midasPayStatus==" + gameSdk.midasPaying), wx.requestMidasPayment({ mode: n.mode, env: n.env, offerId: n.offerId, currencyType: n.currencyType, platform: n.platform, buyQuantity: o, zoneId: n.zoneId, success: function success(e) {
          myLog({ name: "成功回调", res: e }), _confirmPay(orderCode).then(function (e) {
            var t = getOrderStatus(_code2.default.paySuccess);a(t);
          }).catch(function (e) {
            var a = getOrderStatus(_code2.default.payError, e);t(a);
          });
        }, fail: function fail(e) {
          console.log("米大师错误返回:", e);var a = getOrderStatus(_code2.default.payError, e);t(a);
        } }));
    }).catch(function (e) {
...
}function _confirmPay(e) {
  return http({ orderCode: e }, "POST", "gamepay/confirmPay");
...
}function gameHttps(e, a, t) {
  try {
    return "GET" == t && (e = gameSdk.stringify(e, a)), new Promise(function (n, o) {
      var r = wx.getStorageSync("sessionId") || "";wx.request({ url: e, data: a, method: t, header: { "content-type": "application/json", "session-id": r }, success: function success(e) {
          var a = e.data.code;e.data.data && e.data.data.code && (a = e.data.data.code), 0 == a ? n(e.data) : o(e.data);
        }, fail: function fail(e) {
          o(e);
        } });
    });
  ...
  function e() {
    _classCallCheck(this, e);
      ...
      try {
        if (e.midasPaying) return void console.log("并发调用拦截 midasPay");e.midasPaying = !0, wx.login({ success: function success(d) {
            console.log(d);var c = d.code,
                s = { code: c, appId: _config2.default.appId };gameHttps(_config2.default.api + "login/checkOrRefreshSessionkey", s, "POST").then(function (d) {
    ...
    } }, { key: "login", value: function value(e, a, t) {
      myLog({ name: "logName", time: "00:00" }), gameLogin(e, a, t);
      ...
      try {
        return "GET" == t && (e = this.stringify(e, a)), new Promise(function (n, o) {
          var r = wx.getStorageSync("sessionId") || "";wx.request({ url: _config2.default.api + e, data: a, method: t, header: { "content-type": "application/json", "session-id": r }, success: function success(e) {
              var a = e.data.code;e.data.data && e.data.data.code && (a = e.data.data.code), 0 == a ? n(e.data) : o(e.data);
            }, fail: function fail(e) {
              o(e);
            } });
      ...
      gameHttps(_config2.default.api + "share/readSelfNotice?noticeId=" + e, "", "GET").then(function (e) {
        a(e);
      }).catch(function (e) {
        t(e);
      });
      ...
      try {
        var o = { iv: e, encryptedData: a, appId: _config2.default.appId };gameHttps(_config2.default.api + "user/decryptWXData", o, "POST").then(function (e) {
          t(e);
        }).catch(function (e) {
          n(e);
        });
