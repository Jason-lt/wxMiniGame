...
cc.Class((_cc$Class = {
    ...
    initGameObjectPool: function initGameObjectPool() {
        ...
        for (var i = 0; i < initCountBrick; ++i) {
            var ball = cc.instantiate(this.brickPrefab);
            ...
            for (var i = 0; i < Global.brickRow - 3; i++) {
                for (var j = 0; j < col; j++) {
                    if (Global.arrBrick[i] && Global.arrBrick[i][j]) {
                        ...
                        var col = Global.arrBrick[i][j].j;

                        if (Global.mapInfo[row]) Global.mapInfo[row][col] = 0;
                        if (Global.mapBricks[row]) Global.mapBricks[row][col] = null;
        ...
        for (var i = 0; i < Global.arrBall.length; i++) {
            ...
            if (!ball.isRebound) {
                ...
                if (Global.mapInfo[row][col] == 1) {
                    ...
                    var i = Global.mapBricks[row][col].i;
