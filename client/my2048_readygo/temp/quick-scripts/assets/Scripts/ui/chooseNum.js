(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Scripts/ui/chooseNum.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '0131ek9+YdCY7cDr+bbqAsq', 'chooseNum', __filename);
...
cc.Class({
    ...
    choose2: function choose2() {
        ...
        this.updateData();
        this.gridControllerScript.isShowChooseNum(false);
        //记载使用万能道具打点
        this.biManager();
    },
