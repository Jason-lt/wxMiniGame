(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Scripts/view/itemView.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '01c44mKWW1NGoVqCg7+8euj', 'itemView', __filename);
...
cc.Class({
    ...
    //设置格子宝箱
    setGridBox: function setGridBox() {
    ...
    //快速下落动作
    quickDownAction: function quickDownAction(speed) {
        this.curState = 5;
        this.node.stopAllActions();
        var nodePos = this.node.getPosition();
        var targetPos = this.targetGrid.getPosition();
    ...
    //消除动画
    clearItem: function clearItem(time) {
        this.node.stopAllActions();
        //动作完成则删除节点
    ...
    //缩放动画
    markScaleAni: function markScaleAni(toPos) {
    ...
    //回调grid控制器的合并逻辑
    callBackforMerge: function callBackforMerge() {
        if (this.curState < 3) {
            this.curState = 3;
        }
        var self = this;
    ...
    //格子合并
    itemMerge: function itemMerge(pos) {
        this.curState = 4;
        var finished = cc.callFunc(this.toRemove, this);
