"use strict";
cc._RF.push(module, '055b9l7MfFPy4boMlcNHuA0', 'receiveCmd');
...
tcpManager.receiveCmd = {
    ...
    process: function process(params) {
        ...
        if (result.action == tcpManager.cmdType.normalLogin) {
            ...
            // Global.accumulateSingin = result.data.loginDays;
            // listenUtil.eventCtrl.trigger('updateSinginBtnState', null);
