"use strict";
cc._RF.push(module, '41a6d+zz9JLm6SvBYPugiIf', 'Game');
// Scripts/Game.js
...
cc.Class({
    ...
    //IP地址检测
    loadIp: function loadIp() {
        if (Global.cdnGameConfig.banSwtich) {
            var httpUtils = this.getComponent('httpUtils');
            var self = this;
            httpUtils.sendHttpRequest('https://pv.sohu.com/cityjson?ie=utf-8', function (xhr) {
                ...
                for (var i = 0; i < Global.cdnGameConfig.banList.length; i++) {
                    var str = Global.cdnGameConfig.banList[i];
    ...
    //加载本地掉率配置文件
    loadWeightConfig: function loadWeightConfig() {
    ...
    //加载本地每日挑战的关卡数据
    loadDailyConfig: function loadDailyConfig() {
    ...
    //显示排行榜界面
    showRankWindow: function showRankWindow(canShowGameClub) {
        // var self = this;
    ...
    showGroupRankWindow: function showGroupRankWindow(canShowGameClub) {
        // var self = this;
        // Global.LoadAtlas.loadPrefab('rankUI', (rankPrefab) => {
        //     if (!Global.rankui) {
        //         Global.rankui = cc.instantiate(rankPrefab).getComponent("rankUI");
    ...
    //显示复活界面
    showReviveWindow: function showReviveWindow() {
        // var self = this;
    ...
    //显示成就界面
    showTitleWindow: function showTitleWindow() {
        // var self = this;
    ...
    //显示成就查看界面
    showTitleInfoWindow: function showTitleInfoWindow() {
        // var self = this;
    ...
    //弹出好友互助奖励界面
    showRewardWindow: function showRewardWindow() {
        // var self = this;
    ...
    //显示道具分享弹框
    showPropDialogWindow: function showPropDialogWindow(isChest, showText, parmaIndex) {
        // var self = this;
    ...
    //显示道具数量不足，拉起分享界面
    showAddPropDialogWindow: function showAddPropDialogWindow(parma) {
        // var self = this;
