...
wx.onMessage(params => {
    ...
    switch (params.type) {
        case 'getFriendRank':
            console.log('type111111111:', params.type);
            ...
            break;
        case 'getGroupRank':
            console.log('type2222222222:', params.type);
            openData.cleanCanvas();
            ...
            break;
        case 'getDailyRank':
            console.log('type333333333:', params.type);
            openData.cleanCanvas();
            openData.getFriendCloudStorage({
                shareTicket: params.shareTicket,
                keyList: [
        ...
        case 'getMyInfo':
            ...
            break;
        case 'initFriendRank':
            console.log('type55555555:', params.type);
            //openData.cleanCanvas();
            console.log('*************');
            openData.getFriendCloudStorage({
                keyList: [
            ...
            break;
        case 'getNextFriend':
            console.log('type6666666:', params.type);
            openData.getNextFriendAndDraw(params.score, params.width, params.height);
            break;
        default:
            console.log('type77777777:', params.type);
            break;
    }
})