...
cc.Class({
    ...
    initStoreList: function () {
        var skinArray = [];
        skinArray.push({type : 1, name : "复仇版", photo : loadAtlas.getSpriteFrameFromName('textures/gridItem/items', 'skin5'), price : 0});
        skinArray.push({type : 1, name : "数字", photo : loadAtlas.getSpriteFrameFromName('textures/gridItem/items', 'skin1'), price : 150});
        skinArray.push({type : 1, name : "富豪", photo : loadAtlas.getSpriteFrameFromName('textures/gridItem/items', 'skin2'), price : 300});
        skinArray.push({type : 1, name : "甄嬛传", photo : loadAtlas.getSpriteFrameFromName('textures/gridItem/items', 'skin3'), price : 400});
        skinArray.push({type : 1, name : "脑残版", photo : loadAtlas.getSpriteFrameFromName('textures/gridItem/items', 'skin4'), price : 600});
        skinArray.push({type : 1, name : "扑克版", photo : loadAtlas.getSpriteFrameFromName('textures/gridItem/skins', 'skin5'), price : 800});
