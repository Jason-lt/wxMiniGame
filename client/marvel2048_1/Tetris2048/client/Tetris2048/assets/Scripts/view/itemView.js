...
cc.Class({
    ...
    updateNum: function () {
        if (Global.skinIndexFrame == 0) {
            ...
            console.log('皮肤', Global.skinIndexFrame, this.bornNum, 'skin' + (Global.skinIndexFrame + 1) + '_' + this.bornNum);
            this.num4.spriteFrame = LoadAtlas.getSpriteFrameFromName('textures/gridItem/skins', 'skin' + (Global.skinIndexFrame + 1) + '_' + this.bornNum);
