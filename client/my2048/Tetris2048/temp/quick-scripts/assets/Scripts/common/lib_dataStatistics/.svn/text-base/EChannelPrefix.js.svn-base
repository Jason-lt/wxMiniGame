(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Scripts/common/lib_dataStatistics/EChannelPrefix.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '79936jAA99AV5XxIjsKY9o5', 'EChannelPrefix', __filename);
// Scripts/common/lib_dataStatistics/EChannelPrefix.js
