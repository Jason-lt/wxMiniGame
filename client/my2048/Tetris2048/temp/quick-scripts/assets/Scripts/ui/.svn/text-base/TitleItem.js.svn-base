(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Scripts/ui/TitleItem.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'cfabfmBprhLTLjGCybJs1Ft', 'TitleItem', __filename);
...
cc.Class({
    ...
    setReward: function setReward(reward) {
        this.reward = reward;
        //console.log('奖励钻石个数：', this.reward);
    },
