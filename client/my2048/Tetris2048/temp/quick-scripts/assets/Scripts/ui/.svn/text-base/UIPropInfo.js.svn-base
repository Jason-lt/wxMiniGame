(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Scripts/ui/UIPropInfo.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '12ffdwHqNJKXbzM8sC0XQ98', 'UIPropInfo', __filename);
...
cc.Class({
    ...
    //显示宝箱弹框    
    showChest1: function showChest1() {
        var self = this;
        self.propSprite.setVisible(false);
        self.chest.setVisible(true);
        var myUtil = require('myUtil');
...
cc._RF.pop();
        ...
        //# sourceMappingURL=UIPropInfo.js.map
