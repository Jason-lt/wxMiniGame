"use strict";
cc._RF.push(module, '9a2e31K6eJJqZ0x+7kyGj7s', 'UITitle');
...
cc.Class({
    ...
    initStore: function initStore() {
        ...
        // 使用已购商品数据标记已经拥有商品
        for (var _i = 0; _i < Global.titleData.length; _i++) {
            var index = Global.titleData[_i];
            this.arrItems[index].getComponent('TitleItem').setIsHave();
            this.arrItems[index].getComponent('TitleItem').setDate(Global.titleDateData[_i]);
        }
