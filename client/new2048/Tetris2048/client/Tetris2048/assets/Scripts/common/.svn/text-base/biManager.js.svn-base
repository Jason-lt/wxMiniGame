var biManager = {
    ...
    openTurnTable:100015,//打开转盘
    drivingTurnTable:100016,//主动弹出转盘
    loginReward:100017,//打开登录奖励
    drivingLoginReward:100018,//主动打开登录奖励
    loginRewardReplace:100019,//点击补签
    loginRewardReplaceSuccess:100020,//点击补签成功
    ...
    turnTableShare: 200012, //转盘分享
    turnTableVideo: 200013, //转盘视频
    turnTableDiamond: 200014, //转盘使用钻石
    getProp: 200015, //免费获得道具
    noChargeDiamond: 200016, //转盘免费抽
    loginRewardVideo: 200017, //登录奖励看视频翻倍
    loginRewardShare: 200018, //登录奖励界面分享翻倍

    bilog: function (eventid, params) {
