var shareManager = {
    ...
    getRandomShareByPoint: function (strpoint) {
        ...
        console.log(tywx.PropagateInterface._cachedShareConfig);
        for (var _key in tywx.PropagateInterface._cachedShareConfig) {
            let sharePointInfo = tywx.PropagateInterface._cachedShareConfig[_key];
    ...
    sharePoint: function (strpoint, successcallback, failcallback, extraParam) {
        ...
        tywx.ShareInterface.share(shareinfo.title, shareinfo.imageUrl, shareinfo.sharePointId, shareinfo.shareSchemeId, (obj) => {
            tywx.LOGD(null,"fiel = [shareManager] fun = [sharePoint] obj...");
            console.log(obj);
