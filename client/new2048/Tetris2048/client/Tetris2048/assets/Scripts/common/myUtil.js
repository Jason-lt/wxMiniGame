...
var myUtil = {
    ...
    getPercentString: function (socre) {
        ...
        if (socre < 1) {
            perStr = '0%';
        } else if (socre >= 1 && socre < 4500) {
            perStr = '1%';
        } else if (socre >= 4501 && socre < 9000) {
            perStr = '3%';
        } else if (socre >= 9001 && socre < 90000) {
            perStr = '8%';
        } else if (socre >= 90001 && socre < 180000) {
            perStr = '15%';
        } else if (socre >= 180001 && socre < 270000) {
            perStr = '30%';
        } else if (socre >= 270001 && socre < 360000) {
            perStr = '55%';
        } else if (socre >= 360001 && socre < 450000) {
            perStr = '65%';
        } else if (socre >= 450001 && socre < 540000) {
            perStr = '75%';
        } else if (socre >= 540001 && socre < 630000) {
            perStr = '85%';
        } else if (socre >= 630001 && socre < 720000) {
            perStr = '88%';
        } else if (socre >= 720001 && socre < 810000) {
            perStr = '90%';
        } else if (socre >= 810001 && socre < 900000) {
            perStr = '95%';
        } else {
            perStr = '99%';
        }
