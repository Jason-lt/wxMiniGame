...
cc.Class({
    ...
    initData: function () {
        ...
        if (gridControllerScript) {
            ...
            if (Global.startUIShare) {
                this.doubleBg.active = true;
                gridControllerScript.scoreScript.updateScore(gridControllerScript.scoreScript.scoreNum);
                this.updateMaxLabel(gridControllerScript.scoreScript.scoreNum);
            }
        }
    ...
    setBackground: function () {
        ...
        this.turnTableBtn.x = 50 - canvas.width/2;
    },
    ...
    onShareGame: function () {
        ...
        if (typeof FBInstant !== 'undefined') {
            ...
            ThirdAPI.shareGame('screenshot', this.onShareSuccess.bind(this), this.onShareFail.bind(this), '138');
        }
    },
    ...
    getStoneForShare: function () {
        ...
        if (typeof FBInstant !== 'undefined') {
            ...
            ThirdAPI.shareGame('randomImg', this.onGetStoneSuccess.bind(this), this.onShareFail.bind(this), '131');
        }
    },
