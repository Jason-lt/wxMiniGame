...
cc.Class({
    ...
    setButtonState: function (state) {
        ...
        this.specialLabel.node.active = false;
        if (state == 1) {
    ...
    setPrice: function (price) {
        ...
        if (this.price == "活动领取") {
            ...
            this.buttonState2.active = false;
            this.buttonState3.active = false;
            this.specialLabel.node.active = true;
            this.specialLabel.string = price;
            // this.price = price;
        }
        // 可以购买
    ...
    onButtonBy: function () {
        ...
        if (!this.isHave) {
            ...
            if (this.price == "活动领取") {
                Global.storeUI.getComponent("UIStore").showTipbox('活动领取！');
                return
            }
            ...
            if (!repeat) {
                var indexs = (this.index + this.waretype * 100) + "";
