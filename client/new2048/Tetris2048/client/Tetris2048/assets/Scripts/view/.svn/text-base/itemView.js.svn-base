    ...
    cc.Class({
        ...
        updateNum: function (usePropStatus) {
            ...
            if (Global.skinIndex == 0) {
                ...
                var LoadAtlas = require("LoadAtlas");
                if (Global.skinIndex == 6) {  //国庆限时皮肤
                    this.num4.spriteFrame = LoadAtlas.getSpriteFrameFromName('textures/gridItem/skin7', 'skin' + (Global.skinIndex + 1) + '_' + this.bornNum);
                }else {
        ...
        getSpriteNum: function (spr, num) {
            ...
            var spriteFrame;
            if (Global.skinIndex == 6) {  //国庆限时皮肤
                spriteFrame = LoadAtlas.getSpriteFrameFromName('textures/gridItem/skin7', 'skin' + (Global.skinIndex + 1) + '_' + num);
            }else {
                spriteFrame = LoadAtlas.getSpriteFrameFromName('textures/gridItem/skins', 'skin' + (Global.skinIndex + 1) + '_' + num);
            }
