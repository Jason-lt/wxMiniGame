...
cc.Class({
    ...
    onLoad: function () {
        ...
        listenUtil.eventCtrl.addListen('updateDiversionPos', this.updatePos.bind(this));
    },

    updatePos:function(){
        // ctr.sxAdmanager.setPosition(48,300);
    ...
    initGridData: function (listParma) {
        ...
        // tywx.AdManager.showAd(cc.v2(winSize.width - 48,300));
        var isReward = ThirdAPI.loadAdGetGuideReward();
        if (!isReward) {
            if (tywx.AdManager.getAdNodeByTag("myFirstAdNode")) {
                tywx.AdManager.getAdNodeByTag("myFirstAdNode").showAdNode({x:cc.winSize.width - 48,y:300});
            }
        }
        //自己的交叉导流
            ...
            callback: (entries) => {
                ...
                setTimeout(() => {
                    try {
                        ...
                        console.log("getNextFriend error:",error);
                    }
                }, 500);
            }
        });
    ...
    createItem2: function () {
        ...
        // //生产要下落的格子
        // if (Global.cdnGameConfig.totalSwith && Global.historyMaxScore <= parseInt(Global.cdnGameConfig.histroyMaxScore) &&
    ...
    onCloseTipsWindow:function(){
        ...
        if (this.rewardType == 2){
            ThirdAPI.shareGame('randomImg', this.onBombShareSuccess.bind(this), this.onBombShareFail.bind(this), '170');
        }else {
    ...
    onBombShare:function() {
        ...
        if (typeof FBInstant !== 'undefined') {
            ...
            if (Global.cdnGameConfig && Global.cdnGameConfig.totalSwith) {
                ...
                // var wxRewardVideoAd = require('wxRewardVideoAd');
                // wxRewardVideoAd.initCreateReward(this.onStartBomb.bind(this), this.onBombAdFail.bind(this));
                this.tipsWindow.active = true;
                this.setTipwWindowType(2);
                this.tipsWindow.setLocalZOrder(10);
            } else {
                this.onPauseGameForOther();
                // var wxRewardVideoAd = require('wxRewardVideoAd');
                // wxRewardVideoAd.initCreateReward(this.onStartBomb.bind(this), this.onBombAdFail.bind(this));
                this.tipsWindow.active = true;
                this.setTipwWindowType(1);
                this.tipsWindow.setLocalZOrder(10);
            }
    ...
    // 1看视频  2概率看视频
    setTipwWindowType:function(type){
