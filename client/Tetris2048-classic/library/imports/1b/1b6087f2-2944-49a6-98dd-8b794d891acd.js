"use strict";
cc._RF.push(module, '1b608fyKURJppjdi3lNiRrN', 'ThirdApi');
...
var ThirdAPI = {
    ...
    registOnShow: function registOnShow(params) {
        console.log('ThirdAPI registOnShow');

        if (Platform === 1) {
            return WXGlobal.registOnShow(params);
        } else if (Platform === 2) {}
    },
    ...
    getEnterGroupShareInfo: function getEnterGroupShareInfo() {
        console.log('ThirdAPI getEnterGroupShareInfo');

        if (Platform === 1) {
            return WXGlobal.getEnterGroupShareInfo();
        } else if (Platform === 2) {}
    },
