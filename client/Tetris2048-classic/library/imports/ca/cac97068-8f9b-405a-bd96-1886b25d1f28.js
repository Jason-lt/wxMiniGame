"use strict";
cc._RF.push(module, 'cac97Boj5tAWr2WGIayXR8o', 'UIStore');
...
cc.Class({
    ...
    initStoreList: function initStoreList() {
        var skinArray = [];
        skinArray.push({ type: 1, name: "数字", photo: loadAtlas.getSpriteFrameFromName('textures/gridItem/items', 'skin1'), price: 0 });
        skinArray.push({ type: 1, name: "富豪", photo: loadAtlas.getSpriteFrameFromName('textures/gridItem/items', 'skin2'), price: 50 });
        skinArray.push({ type: 1, name: "甄嬛传", photo: loadAtlas.getSpriteFrameFromName('textures/gridItem/items', 'skin3'), price: 150 });
        skinArray.push({ type: 1, name: "脑残版", photo: loadAtlas.getSpriteFrameFromName('textures/gridItem/items', 'skin4'), price: 300 });
        skinArray.push({ type: 1, name: "扑克版", photo: loadAtlas.getSpriteFrameFromName('textures/gridItem/skins', 'skin5'), price: 450 });
        skinArray.push({ type: 1, name: "复仇版", photo: loadAtlas.getSpriteFrameFromName('textures/gridItem/items', 'skin5'), price: 650 });
